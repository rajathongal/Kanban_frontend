...
const CardEditModal = ({
  ...
  const handleSubscribe = async () => {
    try {
      await dispatch(updateSubscriptionOfCard(card._id, { isSubscribed: true }));
  ...
  const handleUnsubscribe = async () => {
    try {
      await dispatch(updateSubscriptionOfCard(card._id, { isSubscribed: false }));
